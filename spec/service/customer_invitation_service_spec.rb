...
RSpec.describe CustomerInvitationService do
  # Helper method to simulate a file and run the service
  ...
  describe '#call' do
    ...
    it 'sorts the results by user_id' do
      ...
      # Check that the user_ids are in the correct, sorted order
    ...
    it 'skips invalid lines without crashing' do
      ...
      # Should still process the two valid customers
